  ...
  return (
    <section className="mx-auto max-w-7xl px-4">
      <div className="rounded-3xl bg-brand-100 px-6 py-10 text-center sm:px-12">
        <h2 className="font-display text-2xl font-bold text-brand-900 sm:text-3xl">Receba novidades e cupons exclusivos</h2>
        <p className="mt-2 text-brand-800">Cadastre seu e-mail e fique por dentro dos lançamentos.</p>
        {sent ? (
          <p className="mt-6 font-semibold text-green-700">Obrigado! Em breve você receberá nossas novidades. 💜</p>
        ) : (
          <form
            onSubmit={(e) => {
              e.preventDefault();
